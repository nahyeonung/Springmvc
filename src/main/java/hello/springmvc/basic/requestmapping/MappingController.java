...
public class MappingController {
    ...
    /**
     * 파라미터로 추가 매핑(지정한 파라미터 값이 요청되어야 매핑됨)
     * params="mode"
     * params="!mode"
     * params="mode=debug"
     * params="mode!=debug"
     ...
     * request Content-Type은 consumes
     ...
     * response Content-Type은 produces
     * produces = "text/html"
     * produces = "!text/html"
     * produces = "text/*"
     * produces = "*\/*"
     */
    @RequestMapping(value="/mapping-produces", produces = MediaType.TEXT_HTML_VALUE)
